...
.then(conn => {
    ...
    this.getUserUploaded = id => new Promise((resolve, reject) => conn.execute(`SELECT name, id, orgName, extension, createTime, deleted, public, link From File Where ownerID = ?`, [id])
    .then(v => {
